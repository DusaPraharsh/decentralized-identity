...
const {
  util,
} = require("/Users/antony/Desktop/DigitalIdentityProject/node_modules/web3-utils/src/soliditySha3.js");
...
const main = async () => {
  ...
  const identifierContractFactory = await hre.ethers.getContractFactory(
    "ERC721Identifier"
  );
  ...
  console.log(
    "Does owner have minter role: %s",
    await identifierContract.hasRole(MINTER_ROLE, owner.address)
  );
  console.log("yup!");
  let identiferCount;
